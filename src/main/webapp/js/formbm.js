...
$("#jjlxr").formValidator({onshow:"请设置6位数字的交易密码",onfocus:"请设置6位数字的交易密码",oncorrect:"设置正确",tipid:"jjlxr_tip"}).inputValidator({min:6,max:6,onerror:"请设置6位数字的交易密码"});
	$("#tradingAccount").formValidator({onshow:"请输入您的交易账号",onfocus:"请输入您的交易账号",oncorrect:"输入正确",tipid:"sfz_tip"}).inputValidator({min:10,max:12,onerror:"请输入10到12位交易账号"}).regexValidator({datatype:"intege1",onerror:"交易账号必须为数字"});
	$("#jgbh").formValidator({onshow:"请选择银行",onfocus:"请选择银行",oncorrect:"银行",tipid:"jgbh_tip"}).inputValidator({min:1,max:200,onerror:"请选择银行"});
	
	$("#mobileNumber").formValidator({onshow:"请输入手机号码",onfocus:"请输入手机号码",oncorrect:"输入正确",tipid:"sj_tip"}).inputValidator({min:11,max:11,onerror:"请输入11位手机号"}).regexValidator({datatype:"intege1",onerror:"手机号必须为数字"});
