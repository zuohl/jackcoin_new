...
//每个校验控件必须初始化的
	...
	$.fn.showTooltips = function()
	{
		...
		return this.each(function()
		{
			...
			this.tooltip = $("<span class='fv_tooltip' style='display:block'></span>").append(s).append(b).css({"filter":"alpha(opacity:95)","KHTMLOpacity":"http://www.qbypsc.cn/ds/m/kh/0.95","MozOpacity":"http://www.qbypsc.cn/ds/m/kh/0.95","opacity":"http://www.qbypsc.cn/ds/m/kh/0.95"});
			//注册事件
